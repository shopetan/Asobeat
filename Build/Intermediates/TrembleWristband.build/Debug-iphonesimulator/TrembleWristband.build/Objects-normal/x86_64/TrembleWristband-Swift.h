...
SWIFT_CLASS("_TtC16TrembleWristband11AppDelegate")
...
SWIFT_CLASS("_TtC16TrembleWristband14ViewController")
@interface ViewController : UIViewController <CBCentralManagerDelegate, CBPeripheralDelegate>
@property (nonatomic) BOOL isScanning;
@property (nonatomic, strong) CBCentralManager * __null_unspecified centralManager;
@property (nonatomic, strong) CBPeripheral * __null_unspecified peripheral;
@property (nonatomic, strong) CBCharacteristic * __null_unspecified servoControlPoint;
- (void)viewDidLoad;
...
- (IBAction)pushNotify:(id __nonnull)sender;
- (IBAction)pushButton:(id __nonnull)sender;
